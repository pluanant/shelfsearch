<head>
	...
	h1 { font-family: "Raleway", "Helvetica Neue", Helvetica, Arial, sans-serif; font-weight: 100; font-size: 280%;text-align: center;color: #FFF7F7;}
	.cep{background-color: #808080; width:97%; height:69.5%; margin: 0.5% 0.5% 0.5% 1.5%;}
        ...
        body{top:0;overflow:hidden;width:100%;height:100%;background: url("<?php echo base_url();?>/public/img/background.jpg") no-repeat;-webkit-background-size:cover;-moz-background-size:cover;-o-background-size:cover;background-size:cover}
